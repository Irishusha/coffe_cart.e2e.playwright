...
import {HomePage, navigateToCartPage, navigateToGitHubPage, navigateToHomePage} from '../../../app/Pages/CoffeeCart/Home.page';
...
test('CCART - 010 GitHub page is opened', async ({ page }) => {
  await navigateToGitHubPage(homePage.githubLink);
...
test('CCART - 011 Shopping Cart page is opened', async ({ page }) => {
  await navigateToCartPage(homePage.cartLink);
